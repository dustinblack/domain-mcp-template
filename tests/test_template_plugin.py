...
#     fixture_dir = Path(__file__).parent / "fixtures" / "template"
#     fixture_path = fixture_dir / "source_response_sample.json"
#     with open(fixture_path) as f:
#         source_data = json.load(f)
#
#     # Load expected metrics
#     expected_path = fixture_dir / "expected_metrics.json"
...
#         expected_ts = expected_metric["timestamp"].replace("Z", "+00:00")
#         assert actual.timestamp.isoformat() == expected_ts
